            ...
            <form id="{{ $form_name }}" action="{{ $route }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <img id="photoPreview" class="rounded-circle mt-3" width="100" height="100" src="">
                    </div>
                    @error('photo')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="is_admin_checkbox" name="is_admin_checkbox">
