...
<div class="mb-4 row align-items-center">
    ...
    <div class="col-md-6 text-start">
        ...
        <input type="text" class="form-control" name="section_title_en" id="section_title_en"
            value="{{ $settings['en']['section_title'] ?? '' }}" placeholder="Enter Section Name in English" />
    ...
    <div class="col-md-6 text-end">
        ...
        <input type="text" class="form-control" name="section_title_ar" id="section_title_ar"
            value="{{ $settings['ar']['section_title'] ?? '' }}" placeholder="أدخل اسم القسم" dir="rtl" />
...
<div class="mb-4 row align-items-center">
    <div class="col-md-6 text-start">
        ...
        <input type="text" class="form-control" name="title_en" id="title_en"
            value="{{ $settings['en']['title'] ?? '' }}" placeholder="Enter Title in English" />
        @error('title_en')
            <span class="text-danger">{{ $message }}</span>
        @enderror
    </div>
    <div class="col-md-6 text-end">
        ...
        <input type="text" class="form-control" name="title_ar" id="title_ar"
            value="{{ $settings['ar']['title'] ?? '' }}" placeholder="أدخل العنوان" dir="rtl" />
        @error('title_ar')
            <span class="text-danger">{{ $message }}</span>
        @enderror
    </div>
