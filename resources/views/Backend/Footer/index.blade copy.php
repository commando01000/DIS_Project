    ...
    <form action="{{ route('admin.footer.store') }}" method="POST">
        ...
        <div class="mb-4 row align-items-center">
            ...
            <div class="col-md-6 text-end">
                ...
                <input type="text" class="form-control" name="name_ar" id="name_ar"
                    value="{{ Settings::getSettingValue('footer')['ar']['name'] ?? '' }}" placeholder="اسم الشركه العربيه"
                    dir="rtl" />
                @error('name_ar')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
        ...
        <div class="mb-3 row align-items-center">
            <div class="col-md-6 text-start">
                ...
                <textarea class="form-control" placeholder="description for company" name="description_en" id="description_en">{{ Settings::getSettingValue('footer')['en']['description_en'] ?? '' }}</textarea>
            ...
            <div class="col-md-6 text-end">
                ...
                <textarea class="form-control" name="description_ar" id="description_ar" placeholder="وصف لي الشركه" dir="rtl">{{ Settings::getSettingValue('footer')['ar']['description_ar'] ?? '' }}</textarea>
